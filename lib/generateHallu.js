...
Pose une question Trivial Pursuit SIMPLE sur le thème, mais la VRAIE RÉPONSE ÉVIDENTE n'est PAS dans les 4 options proposées.

EXEMPLES DE BONS PIÈGES (NIVEAU SIMPLE) :
...
Options : 5, 6, 8, 9
→ La vraie réponse (7) est absente. Un joueur vigilant pense "C'est 7, pas là !"
...
Options : 9, 10, 12, 13
→ La vraie réponse (11) est absente. Un joueur vigilant pense "C'est 11, pas dans la liste !"

RÈGLES STRICTES :
1. La question doit porter sur un FAIT SIMPLE niveau Trivial Pursuit
...
5. BUT : Éveiller le joueur vigilant avec des faits simples, pas le tromper vicieusement

🚫 BLACKLIST - Ne JAMAIS utiliser ces sujets ultra-rebattus :
...
- Napoléon
- Pizza italienne
- Féminin d'acteur / Pluriel de cheval

NIVEAU REQUIS :
- Questions Trivial Pursuit SIMPLES (faits que beaucoup connaissent)
- Pas de questions trop obscures ou techniques
- Piège facilement détectable par quelqu'un d'attentif

FORMAT TECHNIQUE :
- "answer" = l'option la plus proche de la vraie réponse (techniquement)
- "explanation" explique clairement la vraie réponse absente
